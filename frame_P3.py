...
def p3_frame_fun(p3_frame, main_frame, width_body, height_body):
    ...
    p3_r3_image_path = 'C:\\Users\\synel\\Desktop\\myProjects\\Programming\\Python\\python tkinter\\MedAllal\\program\\img\\26.png'  # Replace with your image path
    p3_r3_img = load_image(p3_r3_image_path, 200, 80)
    p3_r3_button = tk.Button(left_frame, image=p3_r2_img, bg='white', bd=0, highlightthickness=0, cursor= "hand2", command=lambda: change_ass_r(3))
    ...
    right_frame = tk.Frame(p3_frame, width=width_body * 0.7 - 10, height=height_body, bg='#000')
    
    p3_r3_frame = tk.Frame(right_frame, width=width_body * 0.7 - 10, height=height_body, bg='#F1EFEF')
    
    image_path1 = 'C:\\Users\\synel\\Desktop\\myProjects\\Programming\\Python\\python tkinter\MedAllal\\program\\img\\20.png'  # Replace with your image path
    ...
    image_path2 = 'C:\\Users\\synel\\Desktop\\myProjects\\Programming\\Python\\python tkinter\MedAllal\\program\\img\\27.png'  # Replace with your image path

    img2 = load_image(image_path2, 100, 100)
    ...
    image_path3 = 'C:\\Users\\synel\\Desktop\\myProjects\\Programming\\Python\\python tkinter\MedAllal\\program\\img\\28.png'  # Replace with your image path

    img3 = load_image(image_path3, 100, 100)
    ...
    image_path1 = 'C:\\Users\\synel\\Desktop\\myProjects\\Programming\\Python\\python tkinter\MedAllal\\program\\img\\19.png'  # Replace with your image path
